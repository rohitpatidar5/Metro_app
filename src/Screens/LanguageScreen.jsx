...
const LanguageScreen = ({ onSelectLanguage }) => {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-white flex flex-col   bg-gradient-to-r from-[#99C3AF] to-[#FEF08A] p-4">
    ...
    <Link to='number '>
      <button className="bg-green-500 text-white py-2 px-4 rounded-2xl w-[250px] ml-6 mt-[260px]">Continue</button>
      </Link>
      </div>
    </div>
  );
